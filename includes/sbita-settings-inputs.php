...
if (!class_exists('SbitaCoreSettingsInputs')) {
    ...
    class SbitaCoreSettingsInputs
    {
        ...
        {
            add_action('sbita_generate_option', array(__CLASS__, 'default_input_html'), 1, 3);
            add_action('sbita_generate_option__label', array(__CLASS__, 'option_label'), 2, 2);
            add_action('sbita_generate_option__description', array(__CLASS__, 'option_description'), 2, 2);
            add_action('sbita_generate_option_textarea', array(__CLASS__, 'text_area_html'), 2, 3);
            add_action('sbita_generate_option_wp_dropdown_pages', array(__CLASS__, 'dropdown_pages_input'), 10, 3);
            add_action('sbita_generate_option_checkbox', array(__CLASS__, 'checkbox_input'), 10, 3);
            add_action('sbita_generate_option_split', array(__CLASS__, 'split_input'), 10, 3);
            add_action('sbita_generate_option_licence', array(__CLASS__, 'licence_input'), 10, 3);
        }
        ...
        {
            do_action('sbita_generate_option__label', $option, $label);
            ...
            do_action('sbita_generate_option__description', $option);
        }
